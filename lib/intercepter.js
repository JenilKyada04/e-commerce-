...
const Myintercepter = axios.create({
  baseURL: apiurl
})

Myintercepter.interceptors.request.use(config => {
  // manioulate congig
...
Myintercepter.interceptors.response.use(response => {
